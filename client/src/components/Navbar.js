    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">SalesPortal</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/itemses">
            <ListItem button key="Items">
              ...
              <ListItemText className="menu-text" primary="Items" />
            </ListItem>
          </Link>{" "}            
           <Link to="/orderdetailses">
            <ListItem button key="OrderDetails">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="OrderDetails" />
            </ListItem>
          </Link>{" "}            
           <Link to="/orders">
            <ListItem button key="Order">
              ...
              <ListItemText className="menu-text" primary="Order" />
            </ListItem>
          </Link>{" "}            
           <Link to="/customers">
