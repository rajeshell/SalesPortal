...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("SalesPortal_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("SalesPortal.config") // Configuration fileName without the .TOML or .YAML extension
	}
